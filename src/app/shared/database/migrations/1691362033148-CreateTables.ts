...
export class CreateTables1691362033148 implements MigrationInterface {
    name = 'CreateTables1691362033148'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "vagas"."jobs" ("id" uuid NOT NULL, "description" character varying NOT NULL, "enterprise" character varying NOT NULL, "limit_date" TIMESTAMP NOT NULL, "is_active" boolean NOT NULL, "id_recruiter" uuid NOT NULL, "max_candidate" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cf0a6c42b72fcc7f7c237def345" PRIMARY KEY ("id"))`);
